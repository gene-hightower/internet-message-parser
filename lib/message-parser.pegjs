...
list_help       = "List-Help:"i CFWS? "<" URI ">" (CFWS? "," CFWS? "<" URI ">")* CFWS? CRLF

list_subscribe  = "List-Subscribe:"i CFWS? "<" URI ">" (CFWS? "," CFWS? "<" URI ">")* CFWS? CRLF

list_unsubscribe = "List-Unsubscribe:"i CFWS? "<" URI ">" (CFWS? "," CFWS? "<" URI ">")* CFWS? CRLF
